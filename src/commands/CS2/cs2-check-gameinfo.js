...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const commandApi = `curl -X POST -H 'Accept: application/json' -H 'authorization: ${key}' -H 'Content-Type: application/json' -d '{"user": "${user}", "game": "cs2", "command": "gameinfo.sh"}' ${url}`;
