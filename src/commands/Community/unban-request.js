...
module.exports = {
    ...
    async execute (interaction) {
        ...
        unbanSchema.findOne({ Guild: interaction.guild.id }, async (err, data) => {
            if (!data) {
                return await interaction.reply({ content: "The unban requests are currently disabled.", ephemeral: true });
            }
            ...
            if (data) {
                ...
                .setPlaceholder("Why were you banned? Why would we trust that you won't do it again? Etc.")
