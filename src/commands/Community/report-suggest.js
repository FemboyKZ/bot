...
module.exports = {
    ...
    async execute (interaction) {
        ...
        reportSchema.findOne({ Guild: interaction.guild.id }, async (err, data) => {
            if (!data) {
                return await interaction.reply({ content: "The reports/suggestions are currently disabled.", ephemeral: true });
            }
            ...
            if (data) {
                ...
                .setPlaceholder("What happened? Where? / What makes your suggestion worth adding.")
